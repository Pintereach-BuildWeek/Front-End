...
export const articles = [
  ...
  },
  {
    ...
    mustRead: true,
    title: "article 3",
    summary: "I cannot allow any fragment whatever that floats in my memory concerning the great subject of this work to be lost. Though a small particular may appear trifling to some, it will be relished by others; while every little spark adds something to the general blaze: and to please the true, candid, warm admirers of Johnson, and in any degree increase the splendour of his reputation, I bid defiance to the shafts of ridicule, or even of malignity. Showers of them have been discharged at my Journal of a Tour to the Hebrides; yet it still sails unhurt along the stream of time, and, as an attendant upon Johnson,",
    url: "#",
  ...
  },
  {
    ...
    mustRead: true,
    title: "article 6",
    summary: "Talking of Rochester's Poems, he said, he had given them to Mr. Steevens to castrate for the edition of the poets, to which he was to write Prefaces. Dr. Taylor (the only time I ever heard him say any thing witty) observed, that if Rochester had been castrated himself, his exceptionable poems would not have been written.' I asked if Burnet had not given a good Life of Rochester.",
    url: "#",
    category: "Software Development",
    imgUrl: "https://source.unsplash.com/random"
  },
  ...
  },
  {
    ...
    mustRead: true,
    title: "article 8",
    summary: "The hypochondriack disorder being mentioned, Dr. Johnson did not think it so common as I supposed. 'Dr. Taylor (said he,) is the same one day as another. Burke and Reynolds are the same; Beauclerk, except when in pain, is the same. I am not so myself; but this I do not mention commonly.'",
    url: "#",
    category: "Computer Science",
    imgUrl: "https://source.unsplash.com/random",
  },
